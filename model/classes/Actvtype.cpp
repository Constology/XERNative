...
Actvtype::Actvtype(const std::vector<std::string> header, const std::vector<std::string> params)
{
	...
	tsv.append(actv_code_type_id_str).append("\t").append(proj_id_str).append("\t").append(seq_num_str).append("\t").append(actv_short_len_str).append("\t").append(actv_code_type).append("\t").append(actv_code_type_scope).append("\t").append(super_flag).append("\n");
}